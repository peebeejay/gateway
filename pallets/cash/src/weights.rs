...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    ...
    fn support_asset() -> Weight {
        (40_000_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn set_rate_model() -> Weight {
...
impl WeightInfo for () {
    ...
    fn support_asset() -> Weight {
        (40_000_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn set_rate_model() -> Weight {
        (52_000_000 as Weight)
    ...
    fn allow_next_code_with_hash() -> Weight {
        (32_000_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn set_next_code_via_hash(z: u32) -> Weight {
        (50_876_000 as Weight)
            // Standard Error: 0
